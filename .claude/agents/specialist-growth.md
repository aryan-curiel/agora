...
At the start of your turn, read `.claude/agents/specialist-growth/MEMORY.md` if it exists and apply accumulated patterns about which acquisition channels work for which audience types, and which viral mechanics are real vs. wishful thinking.
...
After completing your response, update `.claude/agents/specialist-growth/MEMORY.md` if you observed patterns worth retaining.
