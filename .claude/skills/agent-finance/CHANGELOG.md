...
- Memory update mode: when invoked with `MODE: memory-update` by run-debate after session completion, generates an updated `MEMORY.md` capturing budget calibration patterns, revenue timeline realism, and recurring financial blind spots.
