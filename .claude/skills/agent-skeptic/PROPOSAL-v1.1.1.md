...
## Proposed Changes to agent-skeptic
...
**Rationale:** The current phrasing is clear, but the agent treated it as optional in later rounds, defaulting to statements when raising new risks. Making "every round without exception" explicit prevents this drift and ensures meta-agent and session reports consistently receive the two-question signal to surface in synthesis.
