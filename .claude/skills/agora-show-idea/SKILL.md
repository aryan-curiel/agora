...
3. Display:
   ...
   - Notes (if any exist): show as a table with date, type, and note text
   - Session history table
   - Suggested next action based on lowest-scoring dimensions
4. If no sessions yet, suggest: "No sessions yet. Run /agora-run-debate to start developing this idea."
5. If notes exist, append: "Notes will be surfaced to agents in the next debate session."
