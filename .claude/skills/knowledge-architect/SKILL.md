...
```
Using the knowledge-architect skill, help me determine the best
...
**Input:**
```
Using knowledge-architect, I need to build a system that:
...
**Input:**
```
Using knowledge-architect, I want to:
...
**Input:**
```
Using knowledge-architect, I need to:
